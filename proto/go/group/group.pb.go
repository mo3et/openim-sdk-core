...
type CreateGroupReq struct {
	...
	GroupInfo     *shared.IMGroup `protobuf:"bytes,3,opt,name=groupInfo,proto3" json:"groupInfo,omitempty"`
}
...
type CreateGroupResp struct {
	...
	GroupInfo *shared.IMGroup `protobuf:"bytes,1,opt,name=groupInfo,proto3" json:"groupInfo,omitempty"`
}
...
type GetJoinedGroupsResp struct {
	...
	Groups []*shared.IMGroup `protobuf:"bytes,1,rep,name=groups,proto3" json:"groups,omitempty"`
}
...
type GetGroupMemberOwnerAndAdminResp struct {
	...
	Members []*shared.IMGroupMember `protobuf:"bytes,1,rep,name=members,proto3" json:"members,omitempty"`
}
...
type GetGroupRequestResp struct {
	...
	Requests []*shared.IMGroupRequest `protobuf:"bytes,1,rep,name=requests,proto3" json:"requests,omitempty"`
}
