...
import (
	...
	user "github.com/openimsdk/openim-sdk-core/v3/proto/go/user"
...
type JoinGroupApplicationTips struct {
	...
	Group     *GroupInfo     `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"`
	Applicant *user.UserInfo `protobuf:"bytes,2,opt,name=applicant,proto3" json:"applicant,omitempty"`
...
func (x *JoinGroupApplicationTips) GetApplicant() *user.UserInfo {
	if x != nil {
		return x.Applicant
	}
	return nil
...
var file_group_proto_rawDesc = []byte{
	...
	0x72, 0x41, 0x6e, 0x64, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x10, 0x05, 0x42, 0x41, 0x5a, 0x36, 0x67,
	...
	0x67, 0x72, 0x6f, 0x75, 0x70, 0xaa, 0x02, 0x06, 0x4f, 0x70, 0x65, 0x6e, 0x49, 0x4d, 0x62, 0x06,
...
var file_group_proto_goTypes = []any{
	...
	(*common.RequestPagination)(nil),            // 74: openim.sdk.common.RequestPagination
	(common.ApprovalStatus)(0),                  // 75: openim.sdk.common.ApprovalStatus
	(*user.UserInfo)(nil),                       // 76: openim.sdk.user.UserInfo
}
...
func file_group_proto_init() {
	...
	file_group_proto_msgTypes[19].OneofWrappers = []any{}
	file_group_proto_msgTypes[21].OneofWrappers = []any{}
	type x struct{}
