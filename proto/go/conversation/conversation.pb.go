...
type ConversationArgs struct {
	...
	ConversationID  string   `protobuf:"bytes,1,opt,name=conversationID,proto3" json:"conversationID"`   // Unique conversation ID
	ClientMsgIDList []string `protobuf:"bytes,2,rep,name=clientMsgIDList,proto3" json:"clientMsgIDList"` ///  Client message ID list
}
...
type SearchLocalMessagesParams struct {
	...
	// this is keywordList
	KeywordList          []string `protobuf:"bytes,2,rep,name=keywordList,proto3" json:"keywordList"` // Keyword list
...
type GetAllConversationListResp struct {
	...
	ConversationList []*shared.IMConversation `protobuf:"bytes,1,rep,name=conversationList,proto3" json:"conversationList"` // Details Conversation List
}
