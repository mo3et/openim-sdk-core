...
type GetSpecifiedFriendsResp struct {
	...
	Friends []*shared.FriendInfo `protobuf:"bytes,1,rep,name=friends,proto3" json:"friends,omitempty"`
}
...
func (x *GetSpecifiedFriendsResp) GetFriends() []*shared.FriendInfo {
	if x != nil {
		return x.Friends
	}
	return nil
...
type GetFriendRequestsResp struct {
	...
	Requests []*shared.FriendRequestInfo `protobuf:"bytes,1,rep,name=requests,proto3" json:"requests,omitempty"`
}
...
func (x *GetFriendRequestsResp) GetRequests() []*shared.FriendRequestInfo {
	if x != nil {
		return x.Requests
	}
	return nil
...
func (x *GetFriendsResp) GetFriends() []*shared.FriendInfo {
	if x != nil {
		return x.Friends
	}
	return nil
...
func (x *GetFriendsPageResp) GetFriends() []*shared.FriendInfo {
	if x != nil {
		return x.Friends
	}
	return nil
...
func (x *SearchFriendsInfo) GetFriend() *shared.FriendInfo {
	if x != nil {
		return x.Friend
	}
	return nil
...
type GetBlacksResp struct {
	...
	Blacks []*shared.BlackInfo `protobuf:"bytes,1,rep,name=blacks,proto3" json:"blacks,omitempty"`
}
...
func (x *GetBlacksResp) GetBlacks() []*shared.BlackInfo {
	if x != nil {
		return x.Blacks
	}
	return nil
...
var file_relation_proto_rawDesc = []byte{
	...
	0x06, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x10, 0x01, 0x42, 0x44, 0x5a, 0x39, 0x67, 0x69, 0x74,
	...
	0x65, 0x2f, 0x76, 0x33, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x2f, 0x72, 0x65,
	0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0xaa, 0x02, 0x06, 0x4f, 0x70, 0x65, 0x6e, 0x49, 0x4d, 0x62,
...
var file_relation_proto_goTypes = []any{
	...
	(*shared.FriendInfo)(nil),        // 29: openim.sdk.shared.FriendInfo
	(*shared.FriendRequestInfo)(nil), // 30: openim.sdk.shared.FriendRequestInfo
	...
	(*shared.BlackInfo)(nil),         // 33: openim.sdk.shared.BlackInfo
}
