...
type EventOnFriendApplicationAddedData struct {
	...
	Request *shared.IMFriendRequest `protobuf:"bytes,1,opt,name=request,proto3" json:"request"`
}
...
type EventOnGroupApplicationAddedData struct {
	...
	Request *shared.IMGroupRequest `protobuf:"bytes,1,opt,name=request,proto3" json:"request"`
}
