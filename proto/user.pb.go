...
func (x *GetSelfUserInfoResp) GetUser() *IMUser {
	if x != nil {
		return x.User
	}
	return nil
...
type GetUsersInfoResp struct {
	...
	Users []*IMUser `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`
}
...
func (x *GetUsersInfoResp) GetUsers() []*IMUser {
	if x != nil {
		return x.Users
	}
	return nil
...
func (x *GetUsersInfoFromServerResp) GetUsers() []*IMUser {
	if x != nil {
		return x.Users
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x6e, 0x69, 0x6d, 0x2e, 0x73, 0x64, 0x6b, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64,
	0x2e, 0x49, 0x4d, 0x55, 0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x42, 0x38,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*IMUser)(nil),                       // 16: openim.sdk.shared.IMUser
