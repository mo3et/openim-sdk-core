...
func (x *GetAllConversationListResp) GetConversationList() []*IMConversation {
	if x != nil {
...
func (x *GetConversationListSplitResp) GetConversationList() []*IMConversation {
	if x != nil {
		return x.ConversationList
	}
	return nil
...
type GetOneConversationResp struct {
	...
	Conversation *IMConversation `protobuf:"bytes,1,opt,name=conversation,proto3" json:"conversation,omitempty"`
}
...
func (x *GetOneConversationResp) GetConversation() *IMConversation {
	if x != nil {
...
func (x *GetMultipleConversationResp) GetConversationList() []*IMConversation {
	if x != nil {
		return x.ConversationList
	}
	return nil
...
func (x *SearchConversationResp) GetConversationList() []*IMConversation {
	if x != nil {
		return x.ConversationList
	}
	return nil
...
var file_conversation_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x42, 0x38, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_conversation_proto_goTypes = []interface{}{
	...
	(*IMConversation)(nil),                        // 46: openim.sdk.shared.IMConversation
}
