...
type Conversation struct {
	...
	ConversationType  SessionType     `protobuf:"varint,2,opt,name=conversationType,proto3,enum=openim.sdk.common.SessionType" json:"conversationType,omitempty"`
	...
	RecvMsgOpt        ConvRecvMsgOpt  `protobuf:"varint,7,opt,name=recvMsgOpt,proto3,enum=openim.sdk.common.ConvRecvMsgOpt" json:"recvMsgOpt,omitempty"`
	UnreadCount       int32           `protobuf:"varint,8,opt,name=unreadCount,proto3" json:"unreadCount,omitempty"`
	GroupAtType       ConvGroupAtType `protobuf:"varint,9,opt,name=groupAtType,proto3,enum=openim.sdk.common.ConvGroupAtType" json:"groupAtType,omitempty"`
...
func (x *Conversation) GetConversationType() SessionType {
	if x != nil {
...
func (x *Conversation) GetRecvMsgOpt() ConvRecvMsgOpt {
	if x != nil {
		return x.RecvMsgOpt
	}
	return ConvRecvMsgOpt_ReceiveMessage
}
...
func (x *Conversation) GetGroupAtType() ConvGroupAtType {
	if x != nil {
		return x.GroupAtType
	}
	return ConvGroupAtType_AtNormal
}
...
var file_shared_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x72, 0x41, 0x6e, 0x64, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x10, 0x05, 0x42, 0x2f, 0x5a,
...
var file_shared_proto_goTypes = []interface{}{
	...
	(SessionType)(0),                      // 84: openim.sdk.common.SessionType
	(ConvRecvMsgOpt)(0),                   // 85: openim.sdk.common.ConvRecvMsgOpt
	(ConvGroupAtType)(0),                  // 86: openim.sdk.common.ConvGroupAtType
	(MsgFrom)(0),                          // 87: openim.sdk.common.MsgFrom
	(ContentType)(0),                      // 88: openim.sdk.common.ContentType
	(Platform)(0),                         // 89: openim.sdk.common.Platform
	(MsgStatus)(0),                        // 90: openim.sdk.common.MsgStatus
	(*OfflinePushInfo)(nil),               // 91: openim.sdk.common.OfflinePushInfo
}
...
func file_shared_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_shared_proto_msgTypes[81].Exporter = func(v interface{}, i int) interface{} {
	...
	file_shared_proto_msgTypes[81].OneofWrappers = []interface{}{
