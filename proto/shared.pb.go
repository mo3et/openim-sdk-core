...
func (x *IMConversation) GetConversationType() SessionType {
	if x != nil {
...
func (x *IMConversation) GetRecvMsgOpt() ConvRecvMsgOpt {
	if x != nil {
		return x.RecvMsgOpt
	}
...
func (x *IMConversation) GetGroupAtType() ConvGroupAtType {
	if x != nil {
...
var file_shared_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x65, 0x6e, 0x64, 0x22, 0x9f, 0x2d, 0x0a, 0x09, 0x49, 0x4d, 0x4d, 0x65, 0x73, 0x73,
	...
	0x70, 0x73, 0x12, 0x48, 0x0a, 0x0d, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4d, 0x73, 0x67, 0x54,
	0x69, 0x70, 0x73, 0x18, 0x4f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x6f, 0x70, 0x65, 0x6e,
	0x69, 0x6d, 0x2e, 0x73, 0x64, 0x6b, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x2e, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x4d, 0x73, 0x67, 0x54, 0x69, 0x70, 0x73, 0x48, 0x00, 0x52, 0x0d, 0x73,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x4d, 0x73, 0x67, 0x54, 0x69, 0x70, 0x73, 0x42, 0x09, 0x0a, 0x07,
	...
	0x10, 0x02, 0x2a, 0x6d, 0x0a, 0x0b, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x46, 0x69, 0x6c, 0x74, 0x65,
...
var file_shared_proto_depIdxs = []int32{
	...
	84,  // 1: openim.sdk.shared.IMConversation.conversationType:type_name -> openim.sdk.common.SessionType
	85,  // 2: openim.sdk.shared.IMConversation.recvMsgOpt:type_name -> openim.sdk.common.ConvRecvMsgOpt
	86,  // 3: openim.sdk.shared.IMConversation.groupAtType:type_name -> openim.sdk.common.ConvGroupAtType
	83,  // 4: openim.sdk.shared.IMConversation.latestMsg:type_name -> openim.sdk.shared.IMMessage
