...
type GetSpecifiedFriendsResp struct {
	...
	Friends []*IMFriend `protobuf:"bytes,1,rep,name=friends,proto3" json:"friends,omitempty"`
}
...
func (x *GetSpecifiedFriendsResp) GetFriends() []*IMFriend {
	if x != nil {
		return x.Friends
	}
	return nil
...
type GetFriendRequestsResp struct {
	...
	Requests []*IMFriendRequest `protobuf:"bytes,1,rep,name=requests,proto3" json:"requests,omitempty"`
}
...
func (x *GetFriendRequestsResp) GetRequests() []*IMFriendRequest {
	if x != nil {
		return x.Requests
	}
	return nil
...
func (x *GetFriendsResp) GetFriends() []*IMFriend {
	if x != nil {
		return x.Friends
	}
	return nil
...
func (x *GetFriendsPageResp) GetFriends() []*IMFriend {
	if x != nil {
		return x.Friends
	}
	return nil
...
func (x *SearchFriendsInfo) GetFriend() *IMFriend {
	if x != nil {
		return x.Friend
	}
	return nil
...
type GetBlacksResp struct {
	...
	Blacks []*IMBlack `protobuf:"bytes,1,rep,name=blacks,proto3" json:"blacks,omitempty"`
}
...
func (x *GetBlacksResp) GetBlacks() []*IMBlack {
	if x != nil {
		return x.Blacks
	}
	return nil
...
var file_relation_proto_rawDesc = []byte{
	...
	0x00, 0x12, 0x0a, 0x0a, 0x06, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x10, 0x01, 0x42, 0x38, 0x5a,
...
var file_relation_proto_goTypes = []interface{}{
	...
	(*IMFriend)(nil),                 // 29: openim.sdk.shared.IMFriend
	(*IMFriendRequest)(nil),          // 30: openim.sdk.shared.IMFriendRequest
	(ApprovalStatus)(0),              // 31: openim.sdk.common.ApprovalStatus
	(*RequestPagination)(nil),        // 32: openim.sdk.common.RequestPagination
	(*IMBlack)(nil),                  // 33: openim.sdk.shared.IMBlack
}
