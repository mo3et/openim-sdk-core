...
var FuncMap = map[pb.FuncRequestEventName]callFunc{
	...
	pb.FuncRequestEventName_Log:                                  wrapFunc(open_im_sdk.UserForSDK.Third().Log),
	pb.FuncRequestEventName_UpdateFcmToken:                       wrapFunc(open_im_sdk.UserForSDK.Third().UpdateFcmToken),
	pb.FuncRequestEventName_SetAppBadge:                          wrapFunc(open_im_sdk.UserForSDK.Third().SetAppBadge),
	...
	pb.FuncRequestEventName_CreateTextMessage:                    wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateTextMessage),
	pb.FuncRequestEventName_CreateAdvancedTextMessage:            wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateAdvancedTextMessage),
	pb.FuncRequestEventName_CreateTextAtMessage:                  wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateTextAtMessage),
	pb.FuncRequestEventName_CreateLocationMessage:                wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateLocationMessage),
	pb.FuncRequestEventName_CreateCustomMessage:                  wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateCustomMessage),
	pb.FuncRequestEventName_CreateQuoteMessage:                   wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateQuoteMessage),
	pb.FuncRequestEventName_CreateAdvancedQuoteMessage:           wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateAdvancedQuoteMessage),
	pb.FuncRequestEventName_CreateCardMessage:                    wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateCardMessage),
	pb.FuncRequestEventName_CreateImageMessage:                   wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateImageMessage),
	pb.FuncRequestEventName_CreateSoundMessage:                   wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateSoundMessage),
	pb.FuncRequestEventName_CreateVideoMessage:                   wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateVideoMessage),
	pb.FuncRequestEventName_CreateFileMessage:                    wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateFileMessage),
	pb.FuncRequestEventName_CreateMergerMessage:                  wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateMergerMessage),
	pb.FuncRequestEventName_CreateFaceMessage:                    wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateFaceMessage),
	pb.FuncRequestEventName_CreateForwardMessage:                 wrapFunc(open_im_sdk.UserForSDK.Conversation().CreateForwardMessage),
