...
func getContentType(ct commonpb.ContentType) contentType {
...
var contentTypeMap = map[commonpb.ContentType]contentType{
	// message
	...
	commonpb.ContentType_FriendApplicationApprovedNotification: {
		...
		Get: func(oneof any) any {
			return oneof.(*sdkpb.IMMessage_FriendApplicationApprovedTips).FriendApplicationApprovedTips
		},
		Set: func(msg *sdkpb.IMMessage, elem any) {
			msg.Content = &sdkpb.IMMessage_FriendApplicationApprovedTips{FriendApplicationApprovedTips: elem.(*sdkpb.FriendApplicationApprovedTips)}
		},
	},
